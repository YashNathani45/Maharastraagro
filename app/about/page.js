    ...
    return (
        <div className="space-y-20 max-w-7xl mx-auto px-6">
            ...
            <div className="relative">
                <div className="bg-gradient-to-r from-[#339d9e] to-[#2b7f7f] rounded-3xl p-6 sm:p-12 lg:p-16 text-center text-white overflow-hidden">
                    <div className="absolute inset-0 bg-black/20 rounded-3xl"></div>
                    <div className="relative z-10">
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 break-words leading-tight">
                            About Maharashtra Agro Equipments
                        </h1>
                        <p className="text-base sm:text-xl max-w-3xl mx-auto leading-relaxed opacity-95">
            ...
            {/* Our Story Section */}
            <Reveal className="max-w-6xl mx-auto px-2 sm:px-0">
            ...
            {/* Our Mission Section */}
            <Reveal className="max-w-6xl mx-auto px-2 sm:px-0">
                <div className="relative bg-gradient-to-r from-[#339d9e] to-[#2b7f7f] rounded-3xl p-6 sm:p-12 text-white shadow-xl overflow-hidden">
                    <div className="absolute inset-0 bg-black/30 rounded-3xl"></div>
                    <div className="relative z-10">
                        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">Our Mission</h2>
                        <p className="text-base sm:text-xl text-center max-w-4xl mx-auto leading-relaxed opacity-95">
            ...
            {/* Our Values Section */}
            <Reveal className="max-w-7xl mx-auto px-2 sm:px-0">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-8 sm:mb-12">Our Values</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                    {companyValues.map((value, index) => (
                        <Reveal key={index} delay={0.05 * index} className="relative bg-white rounded-2xl p-6 sm:p-8 text-center shadow-lg border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300 group overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="font-bold text-lg sm:text-xl text-gray-900 mb-3 sm:mb-4">{value.title}</h3>
            ...
            <Reveal className="max-w-6xl mx-auto px-2 sm:px-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                    ...
                    <Reveal className="relative" delay={0.1}>
                        <div className="bg-white rounded-2xl shadow-xl overflow-hidden relative h-64 sm:h-80">
                            <Image
                                src="/2J6A0071.JPG"
            ...
            <Reveal className="max-w-7xl mx-auto px-2 sm:px-0">
                <div className="text-center mb-12">
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Our Equipment in Action</h2>
                ...
                <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-lg">
                    <div className="flex gap-4 sm:gap-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-[#339d9e] scrollbar-track-gray-100">
                        {['/eqiup/1.JPG', '/eqiup/2.JPG', '/eqiup/3.JPG', '/eqiup/4.JPG', '/eqiup/5.JPG', '/eqiup/6.JPG'].map((src) => (
                            <div key={src} className="flex-shrink-0 relative w-64 h-48 sm:w-80 sm:h-64">
                                <Image
                                    src={src}
                                    alt="Agricultural Equipment"
                                    fill
            ...
            <Reveal className="max-w-6xl mx-auto px-2 sm:px-0">
                <div className="relative bg-gradient-to-r from-[#339d9e] to-[#2b7f7f] rounded-3xl p-6 sm:p-12 text-center text-white shadow-xl overflow-hidden">
                    <div className="absolute inset-0 bg-black/30 rounded-3xl"></div>
                    <div className="relative z-10">
                        <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Become a Dealer</h2>
                        <p className="text-base sm:text-xl mb-6 sm:mb-8 max-w-2xl mx-auto opacity-95">
                        ...
                        <div className="flex justify-center">
                            <a href="/become-dealer" className="bg-white text-[#339d9e] font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-full text-base sm:text-lg shadow-lg hover:bg-gray-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                                Become a Dealer
                            </a>
                        </div>
                    </div>
