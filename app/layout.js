  ...
  return (
    <html lang="en">
      <body className="flex flex-col min-h-screen bg-white">
        ...
        <nav className="bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100 sticky top-0 z-50">
          <div className="container mx-auto px-6 py-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              />
              <div className="text-2xl font-bold text-[#339d9e]">
        ...
        {/* Footer */}
        <footer className="bg-white text-[#339d9e] py-12 border-t border-gray-100">
          <div className="container mx-auto px-6">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="border-t border-gray-200 w-full pt-4 mt-4">
                <p className="text-xs text-[#339d9e] text-center">© {new Date().getFullYear()} Maharashtra Agro Equipments. All rights reserved.</p>
              </div>
            </div>
          </div>
        </footer>
